    ...
    this.appartements= [
      {
        ...
        }, 
        {
          ...
          general: {
            nom: "Lot 1",
            annonce:
              "\r\n\tImmeuble ind&eacute;pendant &agrave; louer au loyer attractif. eacute;al stockage de v&eacute;hicules sur plusieurs niveaux.",
            etat: "État d'usage",
            ref: "L 1104 94 002 1",
          },
          statut: {
        ...
        },
        {
          ...
          general: {
            nom: "Lot A4",
            annonce:"Situé à proximité des aéroports de Roissy et du Bourget, ce parc dispose d'un emplacement stratégique.\r\n\r\nLivraison 7 mois après la signature d’un contrat de VEFA",
